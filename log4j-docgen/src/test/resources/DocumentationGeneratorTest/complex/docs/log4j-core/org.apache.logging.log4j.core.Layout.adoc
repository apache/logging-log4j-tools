...
Lays out a apiref:LogEvent[] in different formats.
...
Since 2.6, Layouts can apiref:Encoder[] a `LogEvent` directly to a apiref:ByteBufferDestination[] without creating temporary intermediary objects.
