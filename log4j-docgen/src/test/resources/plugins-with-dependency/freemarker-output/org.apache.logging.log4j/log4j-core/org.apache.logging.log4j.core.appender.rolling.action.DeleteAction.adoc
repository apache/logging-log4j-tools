...
|
|xref:../../org.apache.logging.log4j/log4j-core/org.apache.logging.log4j.core.appender.rolling.action.PathSorter.adoc[PathSorter]?
a|a plugin implementing the xref:PathSorter.adoc[] interface

|ScriptCondition
|xref:../../org.apache.logging.log4j/log4j-core/org.apache.logging.log4j.core.appender.rolling.action.ScriptCondition.adoc[ScriptCondition]?
a|
